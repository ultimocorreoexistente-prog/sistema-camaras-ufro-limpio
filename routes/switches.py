...
def get_switch(current_user, switch_id):
    ...
    try:
        ...
        puertos_info = []
        for i in range(1, min(switch.numero_puertos + 1, 25)):  # Limitar a 24 puertos para visualización
            puertos_info.append({
                'numero': i,
...
def create_switch(current_user):
    ...
    try:
        ...
        switch = Switch(
            ...
            numero_puertos=data.get('numero_puertos', 24),
