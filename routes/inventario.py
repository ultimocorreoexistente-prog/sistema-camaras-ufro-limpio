...
<<<<<<< HEAD
from models import db, Camara, Switch, Nvr, Usuario, Ubicacion
from sqlalchemy.exc import IntegrityError

# ⚠️ TEMPORARILY DISABLED: Routes using non-existent models (FuentePoder, Gabinete, etc.)
# These routes will be re-enabled once the missing models are created

# 1. Definición del Blueprint
inventario_bp = Blueprint('inventario', __name__)

# 2. Status endpoint
@inventario_bp.route('/status', methods=['GET'])
def status():
    """API Status - Temporary maintenance message"""
    return jsonify({
        'status': 'maintenance',
        'message': 'Inventory API temporarily under maintenance. Advanced features disabled.',
        'available_models': ['Camara', 'Switch', 'Nvr', 'Usuario', 'Ubicacion'],
        'disabled_features': [
            'FuentePoder management',
            'Gabinete management', 
            'Network connections',
...
def health():
    ...
    return jsonify({'status': 'ok', 'message': 'Inventory API is running but features are disabled'}), 200

# ======================================================================
# 2. CRUD: CÁMARAS - TEMPORARILY DISABLED
# ======================================================================
...
# ======================================================================
# 3. CRUD: SWITCHES - TEMPORARILY DISABLED
# ======================================================================
...
# ======================================================================
# 4. CRUD: FUENTES DE PODER - TEMPORARILY DISABLED
# ======================================================================
...
# ======================================================================
# 5. CRUD: NVR (Grabadores de Video en Red) - TEMPORARILY DISABLED
# ======================================================================
...
# ======================================================================
# 6. CRUD: GABINETES - TEMPORARILY DISABLED
# ======================================================================
