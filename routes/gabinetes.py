    ...
    try:
        ...
        for g in pagination.items:
            ...
            gabinetes_list.append({
                ...
                'temperatura_actual': getattr(g, 'temperatura_actual', 22),
...
def get_gabinete_detail(current_user, gabinete_id):
    ...
    try:
        ...
        return jsonify({
            ...
            'temperatura_actual': getattr(gabinete, 'temperatura_actual', 22),
...
def get_condiciones_gabinete(current_user, gabinete_id):
    ...
    try:
        ...
        condiciones = {
            ...
            'temperatura': getattr(gabinete, 'temperatura_actual', 22),
