...
email = db.Column(db.String(00), nullable=False)
password_hash = db.Column(db.String(55), nullable=False)
nombre_completo = db.Column(db.String(00), nullable=False)
rol = db.Column(db.String(0), nullable=False) # admin, supervisor, tecnico, visualizador
activo = db.Column(db.Boolean, default=True)
fecha_creacion = db.Column(db.DateTime, default=datetime.utcnow)
username = db.Column(db.String(80), unique=True, nullable=False)
telefono = db.Column(db.String(0))
nombre = db.Column(db.String(00)) # Campo adicional que existe en BD
permisos = db.Column(db.Text)
departamento = db.Column(db.String(00))
...
edificio = db.Column(db.String(00), nullable=False)
...
tipo_ubicacion_detallada = db.Column(db.String(00))
...
estado = db.Column(db.String(0), default='Activo')
...
estado = db.Column(db.String(0), default='Disponible') # En uso/Disponible/Averiado
tipo_conexion = db.Column(db.String(0)) # PoE/Fibra/Normal
nvr_id = db.Column(db.Integer, db.ForeignKey('nvr_dvr.id'))
puerto_nvr = db.Column(db.String(0))
...
codigo = db.Column(db.String(50), unique=True, nullable=False)
modelo = db.Column(db.String(100))
voltaje = db.Column(db.String(0))
amperaje = db.Column(db.String(0))
equipos_que_alimenta = db.Column(db.Text)
ubicacion_id = db.Column(db.Integer, db.ForeignKey('ubicaciones.id'))
gabinete_id = db.Column(db.Integer, db.ForeignKey('gabinetes.id'))
estado = db.Column(db.String(0), default='Activo')
...
tipo_camara = db.Column(db.String(0)) # Domo/PTZ/Bullet
ubicacion_id = db.Column(db.Integer, db.ForeignKey('ubicaciones.id'))
gabinete_id = db.Column(db.Integer, db.ForeignKey('gabinetes.id'))
...
tipo_conexion = db.Column(db.String(0))
estado = db.Column(db.String(0), default='Activo') # Activo/Inactivo/Mantenimiento/Baja
fecha_alta = db.Column(db.Date)
fecha_baja = db.Column(db.Date)
motivo_baja = db.Column(db.Text)
instalador = db.Column(db.String(00))
fecha_instalacion = db.Column(db.Date)
observaciones = db.Column(db.Text)
latitud = db.Column(db.Float)
longitud = db.Column(db.Float)
...
id = db.Column(db.Integer, primary_key=True)
nombre = db.Column(db.String(00), nullable=False)
categoria = db.Column(db.String(100))
descripcion = db.Column(db.Text)
gravedad = db.Column(db.String(0)) # Baja/Media/Alta/Critica
...
descripcion = db.Column(db.Text)
prioridad = db.Column(db.String(0)) # Baja/Media/Alta/Critica
fecha_reporte = db.Column(db.DateTime, default=datetime.utcnow)
reportado_por_id = db.Column(db.Integer, db.ForeignKey('usuarios.id'))
estado = db.Column(db.String(0), default='Pendiente') # Pendiente/Asignada/En Proceso/Reparada/Cerrada/Cancelada
...
equipo_id = db.Column(db.Integer, nullable=False)
tipo = db.Column(db.String(0), nullable=False) # Preventivo/Correctivo/Predictivo
...
telefono = db.Column(db.String(0))
email = db.Column(db.String(00))
estado = db.Column(db.String(0), default='Activo') # Activo/Inactivo
...
equipo_tipo = db.Column(db.String(50), nullable=False)
equipo_id = db.Column(db.Integer, nullable=False)
estado_anterior = db.Column(db.String(0))
estado_nuevo = db.Column(db.String(0), nullable=False)
fecha_cambio = db.Column(db.DateTime, default=datetime.utcnow)
motivo = db.Column(db.Text)
usuario_id = db.Column(db.Integer, db.ForeignKey('usuarios.id'))

# FUNCIÓN CORREGIDA - SOLO PARA USO MANUAL
...
print(f' Error al corregir estructura usuarios: {e}')

# FUNCIÓN ELIMINADA PARA EVITAR INICIALIZACIÓN AUTOMÁTICA
# def init_database(): # ← ESTA FUNCIÓN CAUSABA EL PROBLEMA 50
# """FUNCIÓN ELIMINADA - NO EJECUTAR EN PRODUCCIÓN"""
# try:
# fix_usuarios_structure()
# db.create_all() # ← ESTA LÍNEA CAUSABA EL ERROR 50
