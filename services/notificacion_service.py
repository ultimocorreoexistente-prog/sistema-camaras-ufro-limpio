...
class NotificacionService:
    ...
    def notify_failure(self, failure_data: Dict) -> Dict[str, Any]:
        ...
        <body>
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #d32f2f;">🚨 Nueva Falla Reportada</h2>
                ...
                <div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; margin: 20px 0;">
                    ...
                    <p><strong>Severidad:</strong> 
                        <span style="color: {'#d32f2f' if failure_data.get('severidad') == 'alta' else '#ff9800' if failure_data.get('severidad') == 'media' else '#4caf50'}; font-weight: bold;">
    ...
    def notify_maintenance(self, maintenance_data: Dict, users_to_notify: List[int] = None) -> Dict[str, Any]:
        ...
        <body>
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #1976d2;">🔧 Mantenimiento Programado</h2>
                ...
                <p style="color: #d32f2f; font-weight: bold;">
                    ⚠️ Durante el mantenimiento, los sistemas pueden experimentar interrupciones temporales.
                </p>
            </div>
        </body>
        </html>
