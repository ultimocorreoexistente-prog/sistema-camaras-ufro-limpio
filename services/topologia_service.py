...
class TopologiaService:
    ...
    ManagementNet[⚙️ Red de Gestión]
...
"""
    ...
    def _generate_camera_topology(self) -> str:
        ...
        try:
            ...
            mermaid_parts.append("    classDef unknown fill:#f3e5f5,stroke:#9c27b0,color:#000")
    ...
    def _generate_empty_diagram(self, message: str) -> str:
        ...
        return f"""graph TD
    Empty[📭 {message}]
    style Empty fill:#f3e5f5,stroke:#9c27b0,color:#000"""
