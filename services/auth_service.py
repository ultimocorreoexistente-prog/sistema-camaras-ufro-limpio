...
"""
Hashea una contraseña usando SHA-56 con salt
"""
salt = secrets.token_hex(16)
password_hash = hashlib.sha56((password + salt).encode()).hexdigest()
...
return hashlib.sha56((password + salt).encode()).hexdigest() == password_hash
except ValueError:
return False
