...
        # db.drop_all() 
        ...
        # 🟢 CORRECCIÓN 2: Usar DROP CASCADE para eliminar dependencias de forma forzada
        try:
            # Usamos un orden semi-manual para asegurar la eliminación de dependientes (ej: Fotografia -> Falla)
            # y forzar el CASCADE para evitar el error.
...
                
                # Usamos metadata.drop_all para limpiar el resto de las tablas si existen
                # o si tienen dependencias más complejas.
