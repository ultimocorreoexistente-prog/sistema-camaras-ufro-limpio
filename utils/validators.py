...
class EmailValidator(Validator):
    ...
    def validate(cls, email: str) -> Tuple[bool, str]:
        ...
        if not cls.is_valid_length(email, 5, 255):
            return False, "Email debe tener entre 5 y 255 caracteres"
...
class FailureValidator(Validator):
    ...
    def validate_data(cls, data: Dict[str, Any]) -> Tuple[bool, List[str]]:
        ...
        elif not cls.is_valid_length(data.get('titulo', ''), 5, 200):
            errors.append("Título debe tener entre 5 y 200 caracteres")
...
class FileValidator(Validator):
    ...
    @classmethod
    def validate_image_file(cls, filename: str, max_size: int = 10 * 1024 * 1024) -> Tuple[bool, str]:
        """
