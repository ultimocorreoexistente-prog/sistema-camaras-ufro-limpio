...
class LimpiadorDatosUFRO:
    ...
    def parsear_fecha(self, fecha_str):
        ...
        try:
            if fecha_str.replace('.', '').isdigit():
                ...
                fecha_excel = pd.to_datetime('1900-01-01') + pd.Timedelta(days=float(fecha_str) - 2)
    ...
    def generar_datos_normalizados(self, directorio_entrada, directorio_salida):
        ...
        try:
            ...
            archivos_limpieza = {
                ...
                'Ejemplos_Fallas_Reales_corregido_20251019_005201.xlsx': self.limpiar_fallas
            }
                ...
                if archivo_path.exists():
                    ...
                    if not df.empty:
                        ...
                        if not df_limpio.empty:
                            ...
                            df_limpio.to_json(json_salida, orient='records', date_format='iso', indent=2)
    ...
    def _generar_reporte_limpieza(self, directorio_salida):
        ...
        with open(archivo_reporte, 'w', encoding='utf-8') as f:
            json.dump(self.stats_limpieza, f, indent=2, ensure_ascii=False, default=str)
