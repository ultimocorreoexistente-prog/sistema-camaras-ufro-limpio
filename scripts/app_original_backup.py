...
return jsonify({
'status': 'success',
'message': ' Base de datos inicializada correctamente. Ahora puede hacer login como admin/admin13',
...
# Importar psycopg en tiempo de ejecución
try:
import psycopg
from psycopg import sql
except ImportError:
return jsonify({
'error': 'psycopg no disponible',
...
'username': charles[] if charles else None,
