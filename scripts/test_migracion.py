...
class TestMigracionDatos(unittest.TestCase):
    ...
    def _crear_datos_test(cls):
        ...
        datos_camaras = {
            'Nombre de Cámara': ['CAM001', 'CAM002', 'CAM003'],
            'IP de Cámara': ['192.168.1.100', '192.168.1.101', 'invalid_ip'],
        ...
        datos_fallas = {
            'ID Falla': ['F001', 'F002', 'F003'],
            'Fecha de Reporte': ['2024-01-01', '2024-01-02', 'invalid_date'],
            'Tipo de Falla': ['Limpieza', 'Daño físico', 'Conectividad'],
            'Cámara Afectada': ['CAM001', 'CAM002', 'CAM999'],
    ...
    def test_limpiar_ip(self):
        ...
        ips_validas = [
            ...
            "10.0.0.1",
            "172.16.0.1",
            "192-168-1-100"  # Formato con guiones
        ]
    ...
    def test_parsear_fecha(self):
        ...
        # Fechas válidas
        fechas_validas = [
            ("2024-01-01", datetime(2024, 1, 1).date()),
            ("01/01/2024", datetime(2024, 1, 1).date()),
            ("15-03-2024", datetime(2024, 3, 15).date()),
            ("03/15/2024", datetime(2024, 3, 15).date())
        ]
    ...
    def test_validar_ip(self):
        ...
        # IPs inválidas
        ips_invalidas = ['invalid_ip', '256.256.256.256', '192.168.1']
        for ip in ips_invalidas:
    ...
    def test_estadisticas_limpieza(self):
        ...
        try:
            ...
            datos_test = {
                ...
                'IP de Cámara': ['192.168.1.100', 'invalid_ip', '192.168.1.102']
            }
    ...
    def test_validaciones_bd_mock(self):
        ...
        with patch('psycopg2.connect') as mock_connect:
            ...
            mock_cursor.return_value.fetchall.return_value = [
                ('CAM001', '192.168.1.100'),
                ('CAM002', '192.168.1.101')
            ]
    ...
    def test_manejo_errores_conexion(self):
        ...
        with patch('psycopg2.connect', side_effect=Exception("Error de conexión")):
    ...
    def test_consistencia_datos(self):
        ...
        datos_inconsistentes = {
            ...
            'IP de Cámara': ['192.168.1.100', '192.168.1.100', '192.168.1.102'],  # IP duplicada
...
class TestIntegracionCompleta(unittest.TestCase):
    ...
    def _crear_datos_completos_test(self):
        ...
        datos_camaras = {
            'Nombre de Cámara': [f'CAM{i:03d}' for i in range(1, 21)],
            'IP de Cámara': [f'192.168.1.{100+i}' for i in range(20)],
            'Campus/Edificio': ['Campus A'] * 10 + ['Campus B'] * 10,
            'Estado de Funcionamiento': ['Funcionando'] * 15 + ['Error'] * 3 + ['fuera de servicio'] * 2,
            'Tipo de Cámara': ['domo'] * 10 + ['bullet'] * 8 + ['ptz'] * 2
        }
    ...
    def test_credenciales_fallidas(self):
        ...
        with patch('psycopg2.connect', side_effect=psycopg2.Error("Credenciales inválidas")):
            resultado = migrador.conectar_bd()
...
def main():
    ...
    parser.add_argument('--port', type=int, default=5432, help='Puerto para pruebas')
