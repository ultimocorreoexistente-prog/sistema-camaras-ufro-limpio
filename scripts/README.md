...
CREATE TABLE camaras (
    ...
    nombre_camara VARCHAR(255) NOT NULL,
    ip_camara INET UNIQUE,
    campus_edificio VARCHAR(255),
    nvr_asociado VARCHAR(255),
