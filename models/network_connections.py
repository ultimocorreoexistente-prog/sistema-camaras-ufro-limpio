...
if self.ancho_banda and self.ancho_banda <= 0:
errores.append("El ancho de banda debe ser mayor a 0")

# Validar latencia
if self.latencia and self.latencia < 0:
errores.append("La latencia no puede ser negativa")

# Validar pérdida de paquetes
if self.perdida_paquetes and (self.perdida_paquetes < 0 or self.perdida_paquetes > 100):
...
if self.perdida_paquetes > 10:
return "Mala"
elif self.perdida_paquetes > 5:
return "Regular"
elif self.latencia and self.latencia > 100:
return "Regular"
elif self.ancho_banda and self.ancho_banda < 10:
return "Regular"
else:
return "Buena"
