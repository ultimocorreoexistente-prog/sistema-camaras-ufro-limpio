...
class NVR(EquipmentBase):
    ...
    video_compression = Column(String(20), nullable=True,  # ✅ Corregido String(20) → String(20)
    ...
    disk_health_status = Column(String(50), nullable=True,  # ✅ Corregido String(20) → String(50)
    ...
    def get_storage_usage_percentage(self):
        ...
        return round((self.storage_used / self.storage_capacity) * 100, 2)  # ✅ Corregido
    ...
    def remove_camera(self, camara):
        ...
        """
        if camara.nvr_id != self.id:  # ✅ Corregido = → !=
            return False
    ...
    def get_cameras_status_summary(self):
        ...
        for camara in self.camaras:
            ...
            elif camara.status == EquipmentStatus.FALLA:
                summary['failing'] += 1
            else:
                summary['offline'] += 1
    ...
    def get_poe_power_usage(self):
        ...
        cameras_poe = [c for c in self.camaras if hasattr(c, 'power_over_ethernet') and c.power_over_ethernet]
...
class NVRCameraChannel(BaseModel, db.Model):
    ...
    stream_type = Column(String(20), default="main", nullable=False,  # ✅ Corregido String(20) → String(20)
