...
class Cabinet(EquipmentBase):
    ...
    # Estado actual
    door_status = Column(String(20), default="closed", nullable=False,
                        comment="Estado de la puerta (open/closed)")
    alarm_status = Column(String(20), nullable=True,
    ...
    def get_humidity_alert_status(self):
        ...
        elif self.humidity_percentage < 20:
...
class GabineteEquipment(BaseModel, db.Model):
    ...
    Attributes:
        ...
        start_unit (int): Unidad de rack donde inicia la instalación
        rack_units_used (int): Unidades de rack que ocupa
        rack_position (int): Posición en el rack (1-42 típico)
    ...
    orientation = Column(String(20), default="front", nullable=False,
